...
<form onerror="customError" action="#action('update')#">
...
<tr>
	...
	<td>
		...
		<input required="yes" type="text" name="id" value="#req.ddns.id#" message="#lang.messageId#" size="40"/>
...
<tr>
	...
	<td>
		<input required="no" type="text" name="proxyserver" value="#req.ddns.proxyserver#" size="40"/>
	</td>
</tr>
<tr>
	<th scope="row">#lang.proxyport#</th>
	<td>
		<input required="no" type="text" name="proxyport" value="#req.ddns.proxyport#" size="4"/>
	</td>
</tr>
<tr>
	<th scope="row">#lang.proxyuser#</th>
	<td>
		<input required="no" type="text" name="proxyuser" value="#req.ddns.proxyuser#" size="20"/>
	</td>
</tr>
<tr>
	<th scope="row">#lang.proxypassword#</th>
	<td>
		<input required="no" type="text" name="proxypassword" value="#req.ddns.proxypassword#" size="20"/>
	</td>
</tr>
<tr>
	<td colspan="2">&nbsp;
