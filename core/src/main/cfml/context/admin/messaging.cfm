...
Mail Settings
		...
		<tr>
			...
			<td width="450"><input type="text" name="logFile" value="#config.mailLogger.file#" required="yes"  style="width:450px" message="#stText.Mail.LogFileMissing#"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="450"><input type="text" name="spoolInterval" value="#config.mailSpoolInterval#" validate="integer" style="width:50px" required="yes"></td>
		</tr>
		<tr>
			<th scope="row">#stText.Mail.Timeout#</th>
			<td width="450"><input type="text" name="timeout" value="#config.mailTimeout#" validate="integer" style="width:50px" required="yes"></td>
		</tr>
		<tr>
...
<cfloop index="idx" from="1" to="#len#" >
	...
	<tr>
		...
		<td nowrap><input onKeyDown="checkTheBox(this)" type="text" name="hostName_#idx#" value="#ms.hostName#" required="yes"  style="width:250px" message="#stText.Mail.ServerMissing##idx#)"></td>
		<td nowrap><input onKeyDown="checkTheBox(this)" type="text" name="username_#idx#" value="#ms.username#" required="no"  style="width:150px" message="#stText.Mail.UserNameMissing##idx#)"></td>
		<td nowrap><input onKeyDown="checkTheBox(this)" type="text" name="password_#idx#" value="#ms.password#" required="no"  style="width:150px" message="#stText.Mail.PasswordMissing##idx#)"></td>
		<td nowrap><input onKeyDown="checkTheBox(this)" type="text" name="port_#idx#" value="#ms.port#" required="no"  style="width:40px" validate="integer" message="#stText.Mail.PortErrorFirst##idx##stText.Mail.PortErrorLast#"></td>
	</tr>
</cfloop>
	<tr>
		<td>
		...
		<td nowrap><input onKeyDown="checkTheBox(this)"  type="text" name="hostName_new" value="" required="no"  style="width:250px"></td>
		<td nowrap><input onKeyDown="checkTheBox(this)" type="text" name="username_new" value="" required="no"  style="width:150px"></td>
		<td nowrap><input onKeyDown="checkTheBox(this)" type="text" name="password_new" value="" required="no"  style="width:150px"></td>
		<td nowrap><input onKeyDown="checkTheBox(this)" type="text" name="port_new" value="" required="no" validate="integer" message="Value for Port (Row #len+1#) must be of type number" style="width:40px"></td>
	</tr>
	<tr>
		<td colspan="8">
		 <table border="0" cellpadding="0" cellspacing="0">
