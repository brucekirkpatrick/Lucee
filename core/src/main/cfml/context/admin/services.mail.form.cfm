			...
			<table class="maintbl">
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="text" name="hostName_#ms.recordcount+1#" value="#data.hostName#" required="yes" class="large" message="#stText.Mail.hostnameMissing#">
							<div class="comment">#stText.mail.serverDesc#</div>
						</td>
					</tr>
					<cfelse>
						<input type="hidden" name="hostName_#ms.recordcount+1#" value="#driver.getHost()#" required="yes" class="large" message="#stText.Mail.hostnameMissing#">
					</cfif>
					...
					<tr>
						...
						<td>
							<input type="text" name="port_#ms.recordcount+1#" value="#data.port#" required="yes"
							validate="integer"
					...
					<cfelse>
						<input type="hidden" name="port_#ms.recordcount+1#" value="#driver.getPort()#" required="yes"validate="integer" message="#stText.Mail.PortErrorFirst#">
					</cfif>
					...
					<tr>
						...
						<td>
							<input type="text" name="username_#ms.recordcount+1#" value="#data.username#" required="no" class="large"
					...
					<tr>
						...
						<td>
							<input type="password" name="password_#ms.recordcount+1#" value="#isNull(data.password)?"":"*********"#" required="no" class="large"
					...
					<tr>
						...
						<td>
							<input class="checkbox" type="checkbox" checked="#!isNull(data.tls) && data.tls#" name="tls_#ms.recordcount+1#"  value="true">
							<div class="comment">#stText.mail.tlsDesc#</div>
						</td>
					</tr>
					<cfelse>
						<input class="checkbox" type="checkbox" checked="#driver.useTLS()#" name="tls_#ms.recordcount+1#" value="true" style="display: none;">
					</cfif>
					...
					<tr>
						...
						<td>
							<input class="checkbox" type="checkbox" checked="#!isNull(data.ssl) && data.ssl#" name="ssl_#ms.recordcount+1#" value="true">
							<div class="comment">#stText.mail.sslDesc#</div>
						</td>
					</tr>
					<cfelse>
						<input class="checkbox" type="checkbox" checked="#driver.useSSL()#" name="ssl_#ms.recordcount+1#" value="true" style="display: none;">
					</cfif>
					...
					<tr>
						...
						<table class="maintbl" style="width:auto">
							...
							<tbody>
									...
									<tr>
										<td><input type="text" name="life_days_#ms.recordcount+1#" value="#data.life.days#"
										...
										<td><input type="text" name="life_hours_#ms.recordcount+1#" value="#data.life.hours#"
											class="number" required="yes" validate="integer"
											message="#stText.Scopes.TimeoutHoursValue#request#stText.Scopes.TimeoutEndValue#"></td>
										<td><input type="text" name="life_minutes_#ms.recordcount+1#" value="#data.life.minutes#"
											class="number" required="yes" validate="integer"
											message="#stText.Scopes.TimeoutMinutesValue#request#stText.Scopes.TimeoutEndValue#"></td>
										<td><input type="text" name="life_seconds_#ms.recordcount+1#" value="#data.life.seconds#"
											class="number" required="yes" validate="integer"
					...
					<tr>
						...
						<table class="maintbl" style="width:auto">
							...
							<tbody>
									...
									<tr>
										<td><input type="text" name="idle_days_#ms.recordcount+1#" value="#data.idle.days#"
											class="number" required="yes" validate="integer"
											message="#stText.Scopes.TimeoutDaysValue#request#stText.Scopes.TimeoutEndValue#"></td>
										<td><input type="text" name="idle_hours_#ms.recordcount+1#" value="#data.idle.hours#"
											class="number" required="yes" validate="integer"
											message="#stText.Scopes.TimeoutHoursValue#request#stText.Scopes.TimeoutEndValue#"></td>
										<td><input type="text" name="idle_minutes_#ms.recordcount+1#" value="#data.idle.minutes#"
											class="number" required="yes" validate="integer"
											message="#stText.Scopes.TimeoutMinutesValue#request#stText.Scopes.TimeoutEndValue#"></td>
										<td><input type="text" name="idle_seconds_#ms.recordcount+1#" value="#data.idle.seconds#"
											class="number" required="yes" validate="integer"
											message="#stText.Scopes.TimeoutSecondsValue#request#stText.Scopes.TimeoutEndValue#"></td>
									</tr>
