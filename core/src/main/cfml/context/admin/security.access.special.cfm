...
<cfelse>
	...
	<cfoutput>	
		...
		<form onerror="customError" action="#go(url.action,"removeSecurityManager")#" method="post">
			<table class="maintbl">
				<thead>
					<tr>
						<th width="1%"></th>
	...
	<cfif hasNoneIndividual>
		<cfoutput>
			...
			<form onerror="customError" action="#go(url.action,'createSecurityManager')#" method="post">
				<table class="maintbl">
					<tbody>
						<tr>
