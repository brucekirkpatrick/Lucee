...
<cfoutput>
	...
	<form onerror="customError" action="#request.self#?virtual=#mapping.virtual#&action=#url.action#&action2=#url.action2#" method="post">
		...
		<table class="maintbl">
			<tbody>
				...
				<tr>
					...
					<td class="tblContent#css#" nowrap <cfif len(mapping.strPhysical)>title="#mapping.strPhysical##newLine()##mapping.Physical#"</cfif>><cfif mapping.readOnly>#cut(mapping.strPhysical,72)#<cfelse><input onKeyDown="checkTheBox(this)" type="text"
				...
				<tr>
					...
					<td class="tblContent#css#" nowrap <cfif len(mapping.strArchive)>title="#mapping.strArchive##newLine()##mapping.Archive#"</cfif>><cfif mapping.readOnly>#cut(mappings.strArchive,72)#<cfelse><input onKeyDown="checkTheBox(this)" type="text"
