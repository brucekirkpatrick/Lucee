...
<cfoutput>
	<form onerror="customError" action="#request.self#?action=#url.action#&action2=#url.action2#&task=#url.task#" method="post">
		...
		<table class="maintbl">
			<tbody>
				...
				<tr>
					...
					<td>
						<input type="text" name="url" value="#task.urlAndPort#" class="xlarge" required="yes"
				...
				<!---<tr>
					...
					<td>
						<input type="text" name="port" value="#task.port#" class="number" required="no" validate="integer">
				...
				<tr>
					...
					<td>
						<input type="text" name="timeout" value="#task.timeout#" class="number" required="no" validate="integer">
				...
				<tr>
					...
					<td>
						<input type="text" name="username" value="#task.username#" class="medium"
						required="no">
				...
				<tr>
					...
					<td>
						...
						<input type="password" name="password" value="#task.password#" class="medium" required="no">
		...
		<table class="maintbl">
			<tbody>
				<tr>
					...
					<td>
						<input type="text" name="proxyserver" value="#task.proxyserver#" class="large" required="no">
						<div class="comment">#stText.Schedule.ProxyServerDesc#</div>
					</td>
				</tr>
				<tr>
					<th scope="row">#stText.Schedule.Port#</th>
					<td><input type="text" name="proxyport" value="#task.proxyport#" class="number" validate="integer" required="no">
				...
				<tr>
					<th scope="row">#stText.Schedule.Username#</th>
					<td>
						<input type="text" name="proxyuser" value="#task.proxyuser#" class="medium" required="no">
				...
				<tr>
					<th scope="row">#stText.Schedule.Password#</th>
					<td>
						<input type="text" name="proxypassword" value="#task.proxypassword#" class="medium" required="no">
		...
		<table class="maintbl">
			<tbody>
				...
				<tr>
					...
					<td>
						<input type="text" name="file" value="#toFile(task.path,task.file)#" class="large" required="no">
						...
						<tr>
							...
							<td>
								<table class="maintbl autowidth">
									...
									<tbody>
										<tr>
											<td><input type="text" name="start_day" value="#task.start.day#" class="number" required="yes" validate="integer"></td>
											<td><input type="text" name="start_month" value="#task.start.month#" class="number" required="yes" validate="integer"></td>
											<td><input type="text" name="start_year" value="#task.start.year#" class="number" required="yes" validate="integer"></td>
											<td>&nbsp;&nbsp;-&nbsp;&nbsp;</td>
											<td><input type="text" name="start_hour" value="#task.start.hour#" class="number" required="yes" validate="integer"></td>
											<td><input type="text" name="start_minute" value="#task.start.minute#" class="number" required="yes" validate="integer"></td>
											<td><input type="text" name="start_second" value="#task.start.second#" class="number" required="yes" validate="integer"></td>
										</tr>
									</tbody>
								</table>
						...
						<tr>
							...
							<td>
								<table class="maintbl autowidth">
									...
									<tbody>
										<tr>
											<td><input type="text" name="end_day" value="#task.end.day#" class="number" required="no" validate="integer"></td>
											<td><input type="text" name="end_month" value="#task.end.month#" class="number" required="no" validate="integer"></td>
											<td><input type="text" name="end_year" value="#task.end.year#" class="number" required="no" validate="integer"></td>
										</tr>
									</tbody>
								</table>
						...
						<tr>
							...
							<td>
								<table class="maintbl autowidth">
									...
									<tbody>
										<tr>
											<td><input type="text" name="end_hour" value="#task.end.hour#" class="number" required="no" validate="integer"></td>
											<td><input type="text" name="end_minute" value="#task.end.minute#" class="number" required="no" validate="integer"></td>
											<td><input type="text" name="end_second" value="#task.end.second#" class="number" required="no" validate="integer"></td>
										</tr>
									</tbody>
								</table>
						...
						<tr>
							...
							<td>
								...
								<table class="maintbl autowidth">
									...
									<tbody>
										<tr>
											<td><input type="text" name="interval_hour" value="#interval.hour#" class="number"
												required="no" validate="integer"
												message="#stText.General.HourError#">
											</td>
											<td><input type="text" name="interval_minute" value="#interval.minute#" class="number"
												required="no" validate="integer"
												message="#stText.General.MinuteError#">
											</td>
											<td><input type="text" name="interval_second" value="#interval.second#" class="number"
												required="no" validate="integer"
