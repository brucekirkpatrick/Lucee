		...
		<table class="maintbl">
			<tbody>
				<tr>
					...
					<td>
						<input type="text" name="host" value="#_host#" class="large" required="yes" message="#stText.services.certificate.hostValidation#">
				...
				<tr>
					...
					<td>
						<input type="text" name="port" value="#_port#" class="number" required="yes" validate="integer"><br />
